...
def analyze_skin(image_bytes: bytes) -> Dict:
    ...
    try:
        ...
        scores = outputs[0][0]
        return {
            "acne_score": round(float(scores[0]), 3),
            "dark_spots_score": round(float(scores[1]), 3),
            "pores_score": round(float(scores[2]), 3),
            "wrinkles_score": round(float(scores[3]), 3),
            "redness_score": round(float(scores[4]), 3),
            "dark_circles_score": round(float(scores[5]), 3),
